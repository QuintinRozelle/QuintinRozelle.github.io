...
class TestBid(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node1 = qbr_dataStructures.Node(self.bid1)
        self.node2 = qbr_dataStructures.Node(self.bid2)
        self.node3 = qbr_dataStructures.Node(self.bid3)
    ...
    def test_bid_in_node_equality(self):
        self.assertEqual(self.node1, qbr_dataStructures.Node(bidReview.Bid(1, "Bid 1", "General Fund", 1000)))
        self.assertEqual(self.node1, qbr_dataStructures.Node(bidReview.Bid(1, "Bid1", "Enterprise", 1400)))
    ...
    def test_load_bids(self):
        ...
        try:
            rbt = bidReview.loadBids('test_bidReviewGood.csv')
            self.assertEqual(str(rbt.root.key), "3 | Title3 | Fund3 | 3.0")
